...
public class BintFiveActivity extends AppCompatActivity {
    ...
    List<ArrayList<Integer>> scoreRecords; // keep track of recorded scores
    List<ArrayList<Integer>> recordIds; // keep track of recorded scores
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bint_five);
        ...
        scoreRecords = new ArrayList<ArrayList<Integer>>(PLAYERS_COUNT);
        recordIds = new ArrayList<ArrayList<Integer>>(PLAYERS_COUNT);
